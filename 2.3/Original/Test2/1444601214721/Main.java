...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("first_instance", "http://ec2-54-174-245-17.compute-1.amazonaws.com");
		instances[1] = new DataCenterInstance("second_instance", "http://ec2-54-175-253-59.compute-1.amazonaws.com");
		instances[2] = new DataCenterInstance("third_instance", "http://ec2-54-175-253-93.compute-1.amazonaws.com");
	}
